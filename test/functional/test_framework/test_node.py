...
class TestNode():
    ...
    def add_p2p_connection(self, p2p_conn, *, wait_for_verack=True, send_version=True, supports_v2_p2p=False, **kwargs):
        ...
        - if TestNode doesn't advertise_v2_p2p, P2PConnection sends version message and v1 P2P is followed
        - if TestNode advertise_v2_p2p, (and if P2PConnections supports v2 P2P)
