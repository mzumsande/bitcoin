...
public:
    ...
    virtual bool BatchWrite(CCoinsMap &mapCoins, const uint256 &hashBlock, bool erase = true, bool interrupted_replay = false);
...
public:
    ...
    bool BatchWrite(CCoinsMap &mapCoins, const uint256 &hashBlock, bool erase = true,  bool interrupted_replay = false) override;
...
public:
     ...
     */
    bool Flush(bool interrupted_replay = false);
