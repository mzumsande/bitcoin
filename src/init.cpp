...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-maxfullrelayincoming=<n>", strprintf("Maximum number of incoming peers with tx-relay (default: %u). Remaining slots up to the total limit of -maxconnections can only be filled with low-traffic block-relay-only incoming peers", DEFAULT_MAX_FULL_RELAY_INBOUND), ArgsManager::ALLOW_ANY, OptionsCategory::CONNECTION);
...
int nMaxConnections;
int nMaxFullRelayIncomingConnections;
...
bool AppInitParameterInteraction(const ArgsManager& args)
{
    ...
    nMaxFullRelayIncomingConnections = args.GetIntArg("-maxfullrelayincoming", DEFAULT_MAX_FULL_RELAY_INBOUND);
...
bool AppInitMain(NodeContext& node, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    connOptions.m_max_inbound_full_relay = nMaxFullRelayIncomingConnections; // todo: this is a maximum. should we do the calculation here?
